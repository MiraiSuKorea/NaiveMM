...
import requests
from Spot_trading.error import ClientError, ServerError
from Spot_trading.lib.utils import get_timestamp
from Spot_trading.lib.utils import cleanNoneValue
from Spot_trading.lib.utils import encoded_string
from Spot_trading.lib.utils import check_required_parameter
...
class API(object):
    ...
    def sign_request(self, http_method, url_path, payload=None):
        ...
        if url_path == "/api/v3/order" and payload['type']=='limit':
